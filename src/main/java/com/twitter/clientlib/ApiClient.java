...
import com.twitter.clientlib.auth.ApiKeyAuth;
...
public class ApiClient {
    ...
    private boolean isOAUth2AccessTokenDefined = false;
    private boolean isOAUth2AutoRefreshToken = false;
    private final List<ApiClientCallback> callbacks = new ArrayList<>();
    ...
    public ApiClient(OkHttpClient client) {
     ...
     public void setTwitterCredentials(TwitterCredentialsBearer credentials) {
        ...
        if(!StringUtils.isEmpty(credentials.getBearerToken())) {
            HttpBearerAuth BearerToken = (HttpBearerAuth) getAuthentication("BearerToken");
    ...
    public void setTwitterCredentials(TwitterCredentialsOAuth2 credentials) {
        ...
        if(!StringUtils.isEmpty(credentials.getTwitterOauth2ClientId()) &&
            !StringUtils.isEmpty(credentials.getTwitterOauth2AccessToken())) {
            OAuth oauth2userToken = (OAuth) getAuthentication("OAuth2UserToken");
            OAuth2AccessToken token = new OAuth2AccessToken(
                credentials.getTwitterOauth2AccessToken(), null, 0,
                credentials.getTwitterOauth2RefreshToken(), null, null);
            oauth2userToken.setAccessToken(token);
            if(!StringUtils.isEmpty(credentials.getTwitterOAuth2ClientSecret())){
              oauth2userToken.setCredentials(credentials.getTwitterOauth2ClientId(), credentials.getTwitterOAuth2ClientSecret(), false);
            }
            isOAUth2AccessTokenDefined = credentials.isOAuth2AccessToken();
            isOAUth2AutoRefreshToken = credentials.isOAUth2AutoRefreshToken();
        }
    }

    public String[] reduceAuthNames(String[] localVarAuthNames) {
        String authName;
        if(localVarAuthNames == null || localVarAuthNames.length == 0) {
            return new String[0];
        }
        if(localVarAuthNames.length > 1) {
            if(isOAUth2AccessTokenDefined && Arrays.asList(localVarAuthNames).contains("OAuth2UserToken")){
                authName = "OAuth2UserToken";
            } else if(isBearerTokenDefined && Arrays.asList(localVarAuthNames).contains("BearerToken")){
                authName = "BearerToken";
            } else {
    ...
    public boolean isOAUth2AutoRefreshToken() {
      return isOAUth2AutoRefreshToken;
    }
    ...
    public OAuth2AccessToken refreshToken() throws ApiException {
      ...
      for (Authentication authentication : authentications.values()) {
        if (authentication instanceof OAuth) {
          accessToken = ((OAuth) authentication).renewAccessToken();
          if (accessToken != null) {
            ((OAuth) authentication).setAccessToken(accessToken);
            for (ApiClientCallback callback : callbacks) {
     ...
     * Set base path
     *
     * @param basePath Base path of the URL (e.g https://api.twitter.com
     ...
     * @return a {@link com.twitter.clientlib.ApiClient} object
     */
     ...
     * @throws com.twitter.clientlib.ApiException If fail to deserialize response body, i.e. cannot read response body
     ...
     * @throws com.twitter.clientlib.ApiException If fail to serialize the given object
     */
     ...
     * @throws com.twitter.clientlib.ApiException If fail to read file content from response and write to disk
     ...
     * @throws com.twitter.clientlib.ApiException If fail to execute the call
     */
     ...
     * @param returnType Return type
     * @return Type
     * @throws com.twitter.clientlib.ApiException If the response has an unsuccessful status code or
     ...
     * @throws com.twitter.clientlib.ApiException If fail to serialize the request body object into a string
     */
